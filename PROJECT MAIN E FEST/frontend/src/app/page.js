      ...
      <section id="features" className="content-section">
        <div className="section-container">
          ...
          <div className="features-grid">
            ...
            <div className="feature-card">
              <div className="feature-icon"><i className="fa-solid fa-file-lines"></i></div>
              <h3 className="feature-title">8-Category Report Engine</h3>
              <p className="feature-desc">Weather, soil, pests, irrigation, chemicals, yield, market finance, and farm operations — compiled from GPS and your farm data.</p>
            </div>
          </div>
        </div>
      </section>
